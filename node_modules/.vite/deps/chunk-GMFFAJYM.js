...
// node_modules/.pnpm/media-captions@1.0.4/node_modules/media-captions/dist/dev/index.js
var ParseErrorCode = {
  LoadFail: 0,
  BadSignature: 1,
  BadTimestamp: 2,
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./srt-parser-K5JL5T3S.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./ssa-parser-OXBXQW6S.js")).default;
        break;
      default:
...
var VTTParser = class {
  ...
  async init(init) {
    ...
    if (init.strict)
      this._block = 1;
    if (init.errors)
      this._errorBuilder = (await import("./errors-XLD7IZFP.js")).ParseErrorBuilder;
  }
...
//# sourceMappingURL=chunk-GMFFAJYM.js.map
