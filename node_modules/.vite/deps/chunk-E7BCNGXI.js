...
// node_modules/.pnpm/@vidstack+react@1.12.13_@types+react@18.3.23_react@18.3.1/node_modules/@vidstack/react/dev/chunks/vidstack-DUlCophs.js
...
parseContent_fn = function(init2) {
  import("./dev-XCX36IHL.js").then(({ parseText, VTTCue, VTTRegion }) => {
...
load_fn = async function() {
  ...
  try {
    const { parseResponse, VTTCue, VTTRegion } = await import("./dev-XCX36IHL.js"), crossOrigin = (_a6 = this[TextTrackSymbol.crossOrigin]) == null ? void 0 : _a6.call(this);
...
var AudioProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-CnCZVzrO-DADYV7XB.js")).AudioProvider(this.target, ctx);
  }
};
...
var _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-3ZPG_odG-5EFQF7LU.js")).HLSProvider(this.target, context);
  }
};
...
var VimeoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-Bt-dOpts-R422JGUW.js")).VimeoProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { resolveVimeoVideoId, getVimeoVideoInfo } = await import("./vidstack-krOAtKMi-WRJLUIBU.js");
...
var YouTubeProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-CoE5RD0i-YWVAPB5O.js")).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { findYouTubePoster, resolveYouTubeVideoId } = await import("./vidstack-Dm1xEU9Q-Q3JPX5CO.js");
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!__privateGet(this, _googleCastLoader)) {
        const $module = await import("./vidstack-BM-FgV9W-3F7WXJQH.js").then(function(n) {
          return n.loader;
        });
    ...
    if (!pending.has(currentKey)) {
      const promise = new Promise(async (resolve, reject) => {
        try {
          ...
          import("./dev-XCX36IHL.js").then(async ({ parseResponse }) => {
            try {
...
var _Captions = class _Captions extends Component {
  ...
  onConnect(el) {
    if (!_Captions.lib()) {
      import("./dev-XCX36IHL.js").then((lib) => _Captions.lib.set(lib));
    }
...
//# sourceMappingURL=chunk-E7BCNGXI.js.map
